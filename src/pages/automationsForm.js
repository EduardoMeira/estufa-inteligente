  ...
  const html = /*html*/ `
    <div class="flex justify-between gap-2 items-center">
      <div class="flex items-center gap-4">
        ...
        <h1 class="text-whi font-semibold text-xl leading-none">
          Automações
        </h1>
      </div>
    ...
    <form class="space-y-5 block">
      <!-- Se -->
      <div>
        <label class="block mb-4 text-xl text-light font-semibold">Se</label>
        <div class="relative">
          <select
            class="w-full appearance-none rounded-lg bg-gray-800 pl-8 pr-3 py-2 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            <option>Umidade do solo</option>
            <option>Temperatura</option>
            <option>Luminosidade</option>
          </select>
          <span class="material-icons absolute left-2 top-1/2 -translate-y-1/2 text-blue-400 text-base">
      ...
      <div>
        ...
        <select
          class="w-full rounded-lg bg-gray-800 px-3 py-2 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          <option>Maior</option>
          <option>Menor</option>
          <option>Igual</option>
      ...
      <div>
        ...
        <div class="flex gap-2">
          <input
            type="number"
            class="flex-1 rounded-lg bg-gray-800 px-3 py-2 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
            placeholder="30"
          />
          <button
            type="button"
      ...
      <div>
        ...
        <div class="relative">
          ...
          <span
            class="material-icons absolute left-2 top-2 text-blue-400 text-base"
            >water_drop</span
          >
        </div>
      </div>
      ...
      <div>
        ...
        <div class="flex gap-2">
          <input
            type="text"
            class="flex-1 rounded-lg bg-gray-800 px-3 py-2 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
            value="Ligar irrigação - umidade do solo"
          />
          <button
            type="button"
            class="rounded-lg bg-gray-700 px-3 py-2 text-sm hover:bg-gray-600"
      ...
      <div class="pt-4">
        <button
          type="button"
          class="w-full rounded-lg bg-red-500 py-2 text-whi font-semibold hover:bg-red-600"
        >
          Excluir automação
        </button>
      </div>
